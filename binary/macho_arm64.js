...
export class MachOARM64Generator {
    ...
    generate(codeBytes, dataBytes, labels) {
        ...
        console.log("DEBUG MachO: dataFileOffset=", dataFileOffset.toString(16), "dataSize=", dataSize, "dataBytes.length=", dataBytes.length);
        // Debug: print first 16 bytes of data
        console.log("DEBUG MachO: dataBytes[427:443]=", dataBytes.slice(427, 443).map(x => x.toString(16).padStart(2, '0')).join(' '));
        if (dataSize > 0) {
