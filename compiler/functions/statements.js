...
export const StatementCompiler = {
    ...
    compileVariableDeclaration(stmt) {
        ...
        for (const decl of stmt.declarations) {
            if (decl.id.type === "Identifier") {
                ...
                if (name === "os") {
                    console.log(`DEBUG compileVariableDeclaration: os, kind=${kind}, offset=${offset}, init=${!!decl.init}`);
                }
                if (offset === undefined) {
                ...
                const hasBuiltinMap = !!(this._currentModuleAst && this._builtinGlobals && this._builtinGlobals[this._currentModuleAst.filename] !== undefined);
    ...
    compileIfStatement(stmt) {
        ...
        // JS 值在 NaN-boxing 中：bit 0 表示布尔值
